...
| Store | Version | Link |
|-------|---------|------|
| Chrome Web Store | v1.0.1 *(v1.0.2 Under Review)* | [Install](https://chromewebstore.google.com/detail/netsuite-field-explorer-e/pdmkaejbieljlcemfjpmgifjljhgniij) |
| Edge Add-ons | v1.0.1 *(v1.0.2 Under Review)* | - |
